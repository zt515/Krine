 ...
 * the namespace without the ordinary Dragon wrappers.
 * </p>
 * <p>
 ...
 * time they are written by Dragon.  Imported variables from the map appear
 * in the Dragon namespace as untyped variables with no modifiers and
 ...
 */
/*
    Implementation notes:  dragon methods are not currently exported to the
...
public class ExternalNameSpace extends NameSpace {
	...
	*/
    ...
    /*
        Note: we could override this method to allow dragon methods to appear in
        the external map.
    */
    ...
    /*
        ...
        allow dragon methods to be inserted into this namespace via the map.
    */
    ...
    */
     ...
     * Dragon primitive types are represented by their object wrappers, so
