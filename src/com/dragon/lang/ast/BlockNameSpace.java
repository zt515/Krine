...
/**
 ...
 getBlockThis().
 @see #getThis(DragonBasicInterpreter)
 This getBlockThis( DragonInterpreter declaringDragonBasicInterpreter )
 {
 ...
 */
     ...
     * "if" statement).
     *
     * @see #getBlockThis(DragonBasicInterpreter)
     */
    public This getThis(DragonBasicInterpreter declaringDragonBasicInterpreter) {
        return getNonBlockParent().getThis(declaringDragonBasicInterpreter);
    }
    ...
    public This getSuper(DragonBasicInterpreter declaringDragonBasicInterpreter) {
        return getNonBlockParent().getSuper(declaringDragonBasicInterpreter);
    }
