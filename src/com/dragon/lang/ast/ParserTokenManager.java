...
public class ParserTokenManager implements ParserConstants {
    ...
    public void SwitchTo(int lexState) {
        if (lexState >= 1 || lexState < 0)
            throw new DragonTokenException("Error: Ignoring invalid lexical state : " + lexState + ". State unchanged.", DragonTokenException.INVALID_LEXICAL_STATE);
        else
    ...
    public Token getNextToken() {
        ...
        for (; ; ) {
            ...
            throw new DragonTokenException(EOFSeen, curLexState, error_line, error_column, error_after, curChar, DragonTokenException.LEXICAL_ERROR);
        }
    }
