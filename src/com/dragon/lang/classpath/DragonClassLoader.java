 ...
 * via URLs.
 */
public class DragonClassLoader extends URLClassLoader {
    DragonClassManager classManager;

    /**
     * @param bases URLs JARClassLoader seems to require absolute paths
     */
    public DragonClassLoader(DragonClassManager classManager, URL[] bases) {
        super(bases);
     ...
     */
    public DragonClassLoader(DragonClassManager classManager, DragonClassPath bcp) {
     ...
     */
    protected DragonClassLoader(DragonClassManager classManager) {
