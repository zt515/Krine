...
/**
 * One of the things DragonClassLoader does is to address a deficiency in
 * URLClassLoader that prevents us from specifying individual classes
 * via URLs.
 */
public class DragonJavaClassLoader extends URLClassLoader implements DragonClassLoader
{
    DragonClassManager classManager;

    /**
     * @param bases URLs JARClassLoader seems to require absolute paths
     */
    public DragonJavaClassLoader(DragonClassManager classManager, URL[] bases) {
        super(bases);
     ...
     */
    public DragonJavaClassLoader(DragonClassManager classManager, DragonClassPath bcp) {
     ...
     */
    protected DragonJavaClassLoader(DragonClassManager classManager) {
     ...
     * <p>
     * An exception is for Dragon lang classes which are always loaded from
     * the same classloader as the language.
     */
    ...
    public Class loadClass(String name, boolean resolve)
		...
		*/
        ...
        if (name.startsWith(ClassManagerImpl.DRAGON_PACKAGE)) {
            try {
                return DragonBasicInterpreter.class.getClassLoader().loadClass(name);
	...
	*/
    ...
    DragonClassManager getClassManager() {
        return classManager;
    }
