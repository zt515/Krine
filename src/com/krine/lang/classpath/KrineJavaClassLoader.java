...
/**
 * One of the things KrineClassLoader does is to address a deficiency in
...
public class KrineJavaClassLoader extends URLClassLoader implements KrineClassLoader {
     ...
     */
    public KrineJavaClassLoader(KrineClassManager classManager, URL[] bases) {
        super(bases);
     ...
     */
    public KrineJavaClassLoader(KrineClassManager classManager, KrineClassPath bcp) {
     ...
     */
    protected KrineJavaClassLoader(KrineClassManager classManager) {
     ...
     * <p>
     * An exception is for Krine lang classes which are always loaded from
    ...
    public Class loadClass(String name, boolean resolve)
		...
		*/
        ...
        if (name.startsWith(ClassManagerImpl.KRINE_PACKAGE)) {
            try {
                return KrineBasicInterpreter.class.getClassLoader().loadClass(name);
    ...
    protected Class findClass(String name)
        ...
        // Don't add the method to KrineClassManager... it's really an impl thing
