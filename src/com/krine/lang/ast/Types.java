...
public class Types {
    ...
    */
    ...
    public static final int LAST_ROUND_ASSIGNABLE = KRINE_ASSIGNABLE;
    ...
    public static boolean isSignatureAssignable(Class[] from, Class[] to, int round) {
        ...
        switch (round) {
            ...
            case KRINE_ASSIGNABLE:
                for (int i = 0; i < from.length; i++)
                    if (!isKrineAssignable(to[i], from[i]))
                        return false;
                return true;
            default:
     ...
     * <p/>
     * <p>
     * Note that the getAssignableForm() method is the primary krine method for
     * checking assignability.  It adds additional krine conversions, etc.
     *
     * @param lhsType assigning from rhsType to lhsType
     * @param rhsType assigning from rhsType to lhsType
     * @see #isKrineAssignable(Class, Class)
     */
    ...
    /**
     * Test if a type can be converted to another type via Krine
     * extended syntax rules (a superset of Java conversion rules).
     */
    static boolean isKrineAssignable(Class toType, Class fromType) {
        try {
            return castObject(
     ...
     * Krine extended syntax rules.  These rules are always a superset of
     ...
     * @param fromValue an Object or krine.Primitive primitive value (including
     ...
     * respect to Krine extended rules.  These rules are always a superset of
     ...
     * or cast is ultimately possible (with respect to Krine) as well as the
	...
	*/
    private static Object castObject(
		...
		*/
        ...
        // Can we use the proxy mechanism to cast a krine.This to
