...
public class ParserTokenManager implements ParserConstants {
    ...
    public void SwitchTo(int lexState) {
        if (lexState >= 1 || lexState < 0)
            throw new KrineTokenException("Error: Ignoring invalid lexical state : " + lexState + ". State unchanged.", KrineTokenException.INVALID_LEXICAL_STATE);
        else
    ...
    public Token getNextToken() {
        ...
        for (; ; ) {
            ...
            throw new KrineTokenException(EOFSeen, curLexState, error_line, error_column, error_after, curChar, KrineTokenException.LEXICAL_ERROR);
        }
    }
